...
# Load datasets
train_data = pd.read_csv("../data/train_2020na.csv_onehotEncoded38.csv")
train_data.dropna(inplace=True)
test_data = pd.read_csv("../data/test_2020na.csv_onehotEncoded38.csv")
save_path = "predictions_stacking_2020na_new.csv"
